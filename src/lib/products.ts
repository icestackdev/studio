...
export const products: Product[] = [
  ...
  },
  {
    ...
    price: 129.99,
    images: [
      { id: 'product-6-1', hint: 'denim jacket' },
      { id: 'product-6-2', hint: 'jacket model' },
    ],
    sizes: ['M', 'L', 'XL'],
    category: 'Jackets',
  },
  ...
  },
  {
    ...
    price: 69.99,
    images: [
      { id: 'product-4-1', hint: 'crewneck sweatshirt' },
      { id: 'product-4-2', hint: 'sweatshirt fabric' },
    ],
    sizes: ['S', 'M', 'L', 'XL'],
    category: 'Sweaters',
  },
  ...
  },
  {
    ...
    price: 95.00,
    images: [
      { id: 'product-6-1', hint: 'floral sundress' },
      { id: 'product-6-2', hint: 'sundress model' },
    ],
    sizes: ['S', 'M', 'L'],
    category: 'Dresses',
  },
  {
    ...
    price: 110.00,
    images: [
      { id: 'product-2-1', hint: 'high-waisted jeans' },
      { id: 'product-2-2', hint: 'jeans model' },
    ],
    sizes: ['26', '28', '30', '32'],
    category: 'Jeans',
  },
  {
    ...
    price: 180.00,
    images: [
      { id: 'product-1-1', hint: 'leather boots' },
      { id: 'product-1-2', hint: 'boots model' },
    ],
    sizes: ['7', '8', '9', '10', '11'],
    category: 'Shoes',
  },
